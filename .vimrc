...
echoh Normal
enddef
au vimrc BufAdd,BufEnter,BufDelete,BufWipeout * au vimrc SafeStateAgain * ++once H()
...
enddef
nn <script> <C-g> <ScriptCmd>J()<CR><scriptCmd>BA()<CR>
...
enddef
au vimrc VimEnter * ++nested if !B()|CA()|endif
