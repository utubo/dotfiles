...
g:vim9skk = {
	...
	roman_table: {
		# AZIK
		kn: 'かん', sn: 'さん', tn: 'たん', nz: 'なん', hn: 'はん', fn: 'ふぁん', mz: 'まん', yn: 'やん', rn: 'らん', wn: 'わん',
		...
		kh: 'くう', sh: 'すう', th: 'つう', nh: 'ぬう', hf: 'ふう', fh: 'ふぉう', mh: 'むう', yh: 'ゆう', rh: 'るう',
